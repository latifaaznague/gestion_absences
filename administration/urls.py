...
urlpatterns = [
    ...
    path("planning/raw-week/", views.planning_week_raw, name="planning_week_raw"),
    
    # Séances
    path('seance/add/', views.seance_add, name='seance_add'),
    path('seance/edit/<int:seance_id>/', views.seance_edit, name='seance_edit'),  # <-- UNIQUEMENT ICI
    path('seance/delete/<int:seance_id>/', views.seance_delete, name='seance_delete'),
    path('get-default-group/', views.get_default_group, name='get_default_group'),
]